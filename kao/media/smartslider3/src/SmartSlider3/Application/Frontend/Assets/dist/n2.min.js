        ...
        function() {
            ...
            class u {
                ...
                F() {
                    ...
                    return k && (S += "perspective(" + k + "px) "), (t || i) && (S += "translate(" + (t || 0) + "%, " + (i || 0) + "%) "), (a || h) && (S += "translate(" + (a || 0) + "px, " + (h || 0) + "px) "), (f || c) && (S += "translate(" + (f || 0) + "%, " + (c || 0) + "%) "), S += n(s, o, u, P), _ && (S += "skewX(" + _ + "deg) "), O && (S += "skewY(" + O + "deg) "), (l || v) && (S += "translate(" + (l || 0) + "px, " + (v || 0) + "px) "), g && (S += "rotate(" + g + "deg) "), m && (S += "rotate(" + m + "deg) "), (w || p) && (S += "rotateY(" + ((w || 0) + (p || 0)) + "deg) "), (y || d) && (S += "rotateX(" + ((y || 0) + (d || 0)) + "deg) "), b === r && (b = 1), M === r && (M = 1), 1 === b && 1 === M || (S += "scale(" + b + ", " + M + ") "), x === r && (x = 1), 1 !== x && (S += "scaleZ(" + x + ") "), S || "translate3d(0, 0, 0)"
                }
                C() {
                    let {
                        n2blur: t
            ...
            doResize() {
                ...
                o = this.Z ? a - this.parentNode.getBoundingClientRect().right - parseInt(h.getPropertyValue("padding-right")) - parseInt(h.getPropertyValue("border-right-width")) + t : -this.parentNode.getBoundingClientRect().left - parseInt(h.getPropertyValue("padding-left")) - parseInt(h.getPropertyValue("border-left-width")) + t, o += u = o % 1, a -= Math.floor(u), (this._width - a <= 0 || this._width - a > 1 || this._offset - o < -1 || this._offset - o >= 0) && (this._offset !== o && (this.V.x = o, this._offset = o, 0 !== o && this.classList.add("n2-ss-no-bga-fixed")), this._width !== a && (this.V.width = a, this._width = a)), this.setVisible && this.setVisible()
            }
            setVisible() {
            ...
            syncStyle() {
                this.q.length ? this.H || (this.H = u(this.show.bind(this), 100)) : (this.H && (a(this.H), delete this.H), this.display = "")
            }
        });
        ...
        ! function(e) {
                ...
                zi = function(t, e) {
                    return t && (s(t) ? t : Ii[t] || function(t) {
                        ...
                        return i && 1 < e.length && i.config ? i.config.apply(null, ~t.indexOf("{") ? [function(t) {
                            for (var e, i, n, r = {}, s = t.substr(1, t.length - 3).split(":"), o = s[0], u = 1, a = s.length; u < a; u++) i = s[u], e = u !== a - 1 ? i.lastIndexOf(",") : i.length, n = i.substr(0, e), r[o] = isNaN(n) ? n.replace(Ei, "").trim() : +n, o = i.substr(e + 1).trim();
                            return r
                        }(e[1])] : function(t) {
                            var e = t.indexOf("(") + 1,
                                i = t.indexOf(")"),
            ...
            var Ni = function(i) {
                ...
                return e.to = function(t, e, i, n) {
                    ...
                    return n.startAt = i, E(n).immediateRender = c(n.immediateRender), this.staggerTo(e, t, n, r, s, o, u)
            ...
            var Ui, Wi = function(t, e, i, n, o, u, a, h, f) {
                ...
                Hi = function(i) {
                    function s(e, t, r, s) {
                        ...
                        var a, h, l, d, p, m, y, b, M = (u = i.call(this, s ? t : E(t), r) || this).vars,
                            _ = M.duration,
                            O = M.delay,
                            k = M.immediateRender,
                            P = M.stagger,
                        ...
                        if (u._targets = z.length ? $(z) : g("GSAP target " + e + " not found. https://greensock.com", !Qt.nullTargetWarn) || [], u._ptLookup = [], u._overwrite = S, F || P || v(_) || v(O)) {
                            if (t = u.vars, (a = u.timeline = new Ni({
                                ...
                                for (h = 0; h < d; h++) {
                                    ...
                                    l.stagger = 0, R && (l.yoyoEase = R), b && mi(l, b), m = z[h], l.duration = +Vi(_, n(u), h, m, z), l.delay = (+Vi(O, n(u), h, m, z) || 0) - u._delay, !P && 1 === d && l.delay && (u._delay = O = l.delay, u._start += O, l.delay = 0), a.to(m, l, y(h, m, z))
                                }
            ...
            var $n, Jn, Kn, tr, ir, nr, rr = Ii.Power0,
                ...
                Lr = function(t, e) {
                    ...
                    var n, r, s, o, u, a, h, f, c, l, v, d, p, g, m, w, y, b, M, _, O, k, P, S, F, C, A, I, R, E, T, z, D = t.style,
                        B = i.scaleX < 0,
                        L = "deg",
                        X = An(t, Ar) || "0";
